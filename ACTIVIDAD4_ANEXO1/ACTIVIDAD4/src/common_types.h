...
*/
    ...
    // Índices de conexión (ANEXO 1)
    int connects_to_room = -1;   // índice de la habitación conectada
    int connects_to_door = -1;   // índice de la puerta en la habitación conectada

    // Compatibilidad con tu nombre viejo (opcional):
    // si NO quieres cambiar tus usos antiguos aún, puedes mantenerlo:
    ...
    float p2_angle;
    // ============================================================
    // NUEVOS CAMPOS (TASK IV - APARTADO D)/ cambios 9/12
    // Puntos de la puerta proyectados en la pared (FRAME ROOM)
    // Estos se rellenan en store_doors_in_room()
    // ============================================================
    Eigen::Vector2f p1_global{0.f, 0.f};
    Eigen::Vector2f p2_global{0.f, 0.f};
    ...
    {
        // average angle taking wrap-around into account
        float a1 = p1_angle;
        float a2 = p2_angle;
        float d = a2 - a1;
